...
# TheFinalPuzzle - Vibe Coding 的最后一块拼图
...
> **⚠️ 整活项目，仅供娱乐！**
>
> 本项目仅为作者在考英语六级前闲的蛋疼而写，**请勿在任何正式开发、生产环境或重要项目中使用**。
...
如果用户在冷却窗口内（最近 5 秒）动过键盘，脚本会**跳过**本次按键，不会跟用户抢键盘控制权。

## 注意事项

- **终端兼容性**: PowerShell / cmd 支持 `cls` 原位清屏刷新；PyCharm 内置终端忽略 `cls`，靠滚行推出旧内容
